...
function App() {
  const image = "https://images.pexels.com/photos/5980889/pexels-photo-5980889.jpeg?auto=compress&cs=tinysrgb&w=600";
  ...
  return (
    <div className='w-full h-screen flex flex-wrap justify-center bg-cover bg-no-repeat'
      style={{  background: url("https://images.pexels.com/photos/5980889/pexels-photo-5980889.jpeg?auto=compress&cs=tinysrgb&w=600") }}
      >
